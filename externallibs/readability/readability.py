...
REGEXES = {
    ...
    #Chinthaka edit -- re.compile('<(a|blockquote|dl|div|img|ol|p|pre|table|ul)', re.I),
    'divToPElementsRe': re.compile('<(a|blockquote|dl|div|img|ol|p|pre|table|ul|iframe)', re.I),
    #'replaceBrsRe': re.compile('(<br[^>]*>[ \n\r\t]*){2,}',re.I),
    #'replaceFontsRe': re.compile('<(\/?)font[^>]*>',re.I),
    #'trimRe': re.compile('^\s+|\s+$/'),
    #'normalizeRe': re.compile('\s{2,}/'),
    #'killBreaksRe': re.compile('(<br\s*\/?>(\s|&nbsp;?)*){1,}/'),
    #chinthaka edit -- uncommented 'videoRe'
...
class Document:
	...
	#print "Chinthaka is editing this"
        try:
            ruthless = True
            while True:
                self._html(True)
		...
		'''
    	#chinthaka edit -- start		
    		print len(candidates)
    		for candidate in candidates:
    			print html.tostring(candidate) + '\n---------------------------------------------------------------------'
    	#chinthaka edit -- end		
        '''
	...
	#chinthaka editing - start
# 	print best_candidate["content_score"]
	#chinthaka editing - end
	...
	#chinthaka edit -- best_candidate = sorted_candidates[0]
        best_candidate = sorted_candidates[0]
# 	print "print best -" + str(best_candidate['elem'].text)
    ...
    def score_paragraphs(self, ):
	    ...
	    #chinthaka edit - commenting the following 2 code lines
...
#Chinthaka edit -- for elem in self.tags(node, "form", "iframe", "textarea"):
